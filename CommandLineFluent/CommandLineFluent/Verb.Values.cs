namespace CommandLineFluent
{
	...
	public sealed partial class Verb<TClass> : IVerb where TClass : class, new()
	{
		...
		public Value<TClass, TEnum> AddValueEnum<TEnum>(Expression<Func<TClass, TEnum>> expression, Action<NamelessArgConfig<TClass, TEnum>> config) where TEnum : struct, Enum
		{
