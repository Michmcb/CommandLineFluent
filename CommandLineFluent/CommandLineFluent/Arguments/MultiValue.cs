...
//	public class MultiValue<T, C> : FluentArgument, IMultiValue, IFluentSettable<T, string[]> where T : new()
//	{
...
//		/// </summary>
//		public Dependencies<T, C> Dependencies { get; private set; }
...
//		/// </summary>
//		public FluentManyValues<T, C> WithDependencies(Action<Dependencies<T, C>> config)
//		{
//			ThrowIfRequirednessAlreadyConfigured();
//			if (config != null)
//			{
//				Required = null;
//				_configuredRequiredness = true;
//				config.Invoke(Dependencies = new Dependencies<T, C>());
//				return this;
//			}
//			else
//			{
