namespace CommandLineFluent.Arguments
{
	...
	/// </summary>
	public class Value<TClass, TProp> : IValue<TClass> where TClass : class, new()
	{
		...
		public Value<TClass, TProp> ForProperty(Expression<Func<TClass, TProp>> expression)
		{
		...
		/// </summary>
		public Value<TClass, TProp> IsRequired()
		{
			ArgumentRequired = ArgumentRequired.Required;
			DefaultValue = default;
			Dependencies = null;
		...
		public Value<TClass, TProp> IsOptional(TProp defaultValue = default)
		{
		...
		/// </summary>
		public Value<TClass, TProp> WithDependencies(TProp defaultValue, Action<Dependencies<TClass, TProp>> config)
		{
			if (config != null)
			{
		...
		public Value<TClass, TProp> WithHelpText(string helpText)
		{
			HelpText = helpText;
			return this;
		}
		...
		public Value<TClass, TProp> WithName(string name)
		{
			Name = name;
			return this;
		}
		...
		public Value<TClass, TProp> WithConverter(Func<string, Converted<TProp>> converter)
		{
			Converter = converter;
			return this;
		}
