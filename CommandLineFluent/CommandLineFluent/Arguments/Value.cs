...
//	public class Value<T, C> : FluentArgument, IValue, IFluentSettable<T, string> where T : new()
//	{
...
//		/// </summary>
//		public FluentValue<T, C> WithDependencies(Action<Dependencies<T, C>> config)
//		{
//			ThrowIfRequirednessAlreadyConfigured();
//			if (config != null)
//			{
