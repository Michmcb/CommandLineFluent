namespace CommandLineFluent
{
	...
	public sealed partial class Verb<TClass> : IVerb where TClass : class, new()
	{
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string, string[]>(false, Converters.ToString, Array);
			config(obj);
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string, List<string>>(false, Converters.ToString, List);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string, IList<string>>(false, Converters.ToString, List);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string, IReadOnlyList<string>>(false, Converters.ToString, List);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string, ICollection<string>>(false, Converters.ToString, List);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string, IReadOnlyCollection<string>>(false, Converters.ToString, List);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string, IEnumerable<string>>(false, Converters.ToString, Enumerable);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string, HashSet<string>>(false, Converters.ToString, HashSet);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string, Stack<string>>(false, Converters.ToString, Stack);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string, Queue<string>>(false, Converters.ToString, Queue);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		...
		public MultiValue<TClass, TEnum, TEnum[]> AddMultiValueEnum<TEnum>(Expression<Func<TClass, TEnum[]>> expression, Action<NamelessMultiArgConfig<TClass, TEnum, TEnum[]>> config) where TEnum : struct, Enum
		{
			var obj = new NamelessMultiArgConfig<TClass, TEnum, TEnum[]>(false, ToEnum<TEnum>, Array);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		public MultiValue<TClass, TEnum, List<TEnum>> AddMultiValueEnum<TEnum>(Expression<Func<TClass, List<TEnum>>> expression, Action<NamelessMultiArgConfig<TClass, TEnum, List<TEnum>>> config) where TEnum : struct, Enum
		{
			var obj = new NamelessMultiArgConfig<TClass, TEnum, List<TEnum>>(false, ToEnum<TEnum>, List);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		public MultiValue<TClass, TEnum, IList<TEnum>> AddMultiValueEnum<TEnum>(Expression<Func<TClass, IList<TEnum>>> expression, Action<NamelessMultiArgConfig<TClass, TEnum, IList<TEnum>>> config) where TEnum : struct, Enum
		{
			var obj = new NamelessMultiArgConfig<TClass, TEnum, IList<TEnum>>(false, ToEnum<TEnum>, List);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		public MultiValue<TClass, TEnum, IReadOnlyList<TEnum>> AddMultiValueEnum<TEnum>(Expression<Func<TClass, IReadOnlyList<TEnum>>> expression, Action<NamelessMultiArgConfig<TClass, TEnum, IReadOnlyList<TEnum>>> config) where TEnum : struct, Enum
		{
			var obj = new NamelessMultiArgConfig<TClass, TEnum, IReadOnlyList<TEnum>>(false, ToEnum<TEnum>, List);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		public MultiValue<TClass, TEnum, ICollection<TEnum>> AddMultiValueEnum<TEnum>(Expression<Func<TClass, ICollection<TEnum>>> expression, Action<NamelessMultiArgConfig<TClass, TEnum, ICollection<TEnum>>> config) where TEnum : struct, Enum
		{
			var obj = new NamelessMultiArgConfig<TClass, TEnum, ICollection<TEnum>>(false, ToEnum<TEnum>, List);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		public MultiValue<TClass, TEnum, IReadOnlyCollection<TEnum>> AddMultiValueEnum<TEnum>(Expression<Func<TClass, IReadOnlyCollection<TEnum>>> expression, Action<NamelessMultiArgConfig<TClass, TEnum, IReadOnlyCollection<TEnum>>> config) where TEnum : struct, Enum
		{
			var obj = new NamelessMultiArgConfig<TClass, TEnum, IReadOnlyCollection<TEnum>>(false, ToEnum<TEnum>, List);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		public MultiValue<TClass, TEnum, IEnumerable<TEnum>> AddMultiValueEnum<TEnum>(Expression<Func<TClass, IEnumerable<TEnum>>> expression, Action<NamelessMultiArgConfig<TClass, TEnum, IEnumerable<TEnum>>> config) where TEnum : struct, Enum
		{
			var obj = new NamelessMultiArgConfig<TClass, TEnum, IEnumerable<TEnum>>(false, ToEnum<TEnum>, Enumerable);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		public MultiValue<TClass, TEnum, HashSet<TEnum>> AddMultiValueEnum<TEnum>(Expression<Func<TClass, HashSet<TEnum>>> expression, Action<NamelessMultiArgConfig<TClass, TEnum, HashSet<TEnum>>> config) where TEnum : struct, Enum
		{
			var obj = new NamelessMultiArgConfig<TClass, TEnum, HashSet<TEnum>>(false, ToEnum<TEnum>, HashSet);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		public MultiValue<TClass, TEnum, Stack<TEnum>> AddMultiValueEnum<TEnum>(Expression<Func<TClass, Stack<TEnum>>> expression, Action<NamelessMultiArgConfig<TClass, TEnum, Stack<TEnum>>> config) where TEnum : struct, Enum
		{
			var obj = new NamelessMultiArgConfig<TClass, TEnum, Stack<TEnum>>(false, ToEnum<TEnum>, Stack);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		public MultiValue<TClass, TEnum, Queue<TEnum>> AddMultiValueEnum<TEnum>(Expression<Func<TClass, Queue<TEnum>>> expression, Action<NamelessMultiArgConfig<TClass, TEnum, Queue<TEnum>>> config) where TEnum : struct, Enum
		{
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string?, string?[]>(false, ToNullableString, Array);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string?, List<string?>>(false, ToNullableString, List);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string?, IList<string?>>(false, ToNullableString, List);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string?, IReadOnlyList<string?>>(false, ToNullableString, List);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string?, ICollection<string?>>(false, ToNullableString, List);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string?, IReadOnlyCollection<string?>>(false, ToNullableString, List);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string?, IEnumerable<string?>>(false, ToNullableString, Enumerable);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string?, HashSet<string?>>(false, ToNullableString, HashSet);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string?, Stack<string?>>(false, ToNullableString, Stack);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		...
		{
			var obj = new NamelessMultiArgConfig<TClass, string?, Queue<string?>>(false, ToNullableString, Queue);
			config(obj);
			return AddMultiValueCore(expression, obj);
		}
		public MultiValue<TClass, short?, short?[]> AddMultiValue(Expression<Func<TClass, short?[]>> expression, Action<NamelessMultiArgConfig<TClass, short?, short?[]>> config)
