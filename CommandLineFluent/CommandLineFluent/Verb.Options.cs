namespace CommandLineFluent
{
	...
	public sealed partial class Verb<TClass> : IVerb where TClass : class, new()
	{
		...
		public Option<TClass, TEnum> AddOptionEnum<TEnum>(Expression<Func<TClass, TEnum>> expression, Action<NamedArgConfig<TClass, TEnum, string>> config) where TEnum : struct, Enum
		{
